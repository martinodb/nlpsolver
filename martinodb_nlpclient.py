...
# martinodb.nlpclient: A python CLI client that calls nlpserver, based on the modified nlpsolver.
#
#
...
import nlpglobals
from nlpglobals import options


# small utilities are in nlputils.py
from nlputils import debug_print, show_error
...
#
# ./martinodb_nlpclient "Elephants are animals. John is an elephant. John is an animal?"
#
...
helptext="""call martinodb_nlpclient with a natural language text like
